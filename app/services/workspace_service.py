...
from app.models.enums import SystemRole, WorkspaceRole
...
class WorkspaceService:
    ...
    def add_member(
        ...
        existing_member = self.workspace_repo.get_member(workspace_id, dto.user_id)
        if existing_member:
            raise HTTPException(
        ...
        return self.workspace_repo.add_member(workspace_id, dto.user_id, dto.role)
