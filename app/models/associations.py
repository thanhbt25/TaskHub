...
from sqlalchemy import Column, BigInteger, ForeignKey, Enum as SQLEnum, String
...
class TaskLabel(Base):
    ...
    label_id = Column(String(36), ForeignKey("labels.id", ondelete="CASCADE"), primary_key=True)
